...
@Presenter(view = WarehousesView.class)
public class WarehousesPresenter extends
        BasePresenter<WarehousesPresenter.IWarehousesView, WarehousesEventBus> {

    public interface IWarehousesView extends BaseViewIntf {
